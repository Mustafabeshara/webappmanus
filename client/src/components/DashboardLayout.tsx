...
import { LayoutDashboard, LogOut, PanelLeft, FileText, DollarSign, Package, Users, TrendingUp, Truck, FolderOpen, BarChart3, Settings, Building2, ShoppingCart, Receipt, UserCircle, ClipboardList, Bell, Shield, CheckSquare, Files, Percent, UserCog, BookOpen, Sparkles, Brain } from "lucide-react";
import { CSSProperties, useEffect, useRef, useState } from "react";
import { useLocation } from "wouter";
import { DashboardLayoutSkeleton } from './DashboardLayoutSkeleton';
import { Button } from "./ui/button";

// Menu items grouped by category for better organization
const menuGroups = [
  {
    label: "Overview",
    items: [
  ...
  },
  {
    ...
    items: [
      ...
      { icon: ClipboardList, label: "Hospital Requests", path: "/requirements" },
    ],
  },
  {
    label: "Operations",
